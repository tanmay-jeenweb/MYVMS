                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="relative">
                                ...
                                {loading && (
                                    <div className="absolute right-3 top-2.5">
                                        <div className="animate-spin h-4 w-4 border-2 border-[#1e3a8a] rounded-full border-t-transparent"></div>
                                    </div>
                                )}
                            </div>
                    ...
                    <div>
                        <button
                            ...
                            className="group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-semibold rounded-lg text-white bg-[#1e3a8a] hover:bg-[#172554] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1e3a8a] transition-colors duration-200 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >

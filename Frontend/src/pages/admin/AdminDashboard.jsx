                ...
                return (
                    <div className="flex justify-end">
                        <button
                            ...
                            className="inline-flex justify-center rounded-md px-4 py-2 text-sm font-semibold text-white bg-[#1e3a8a] hover:bg-[#172554] shadow-sm"
                        >
                            Approve
                        </button>
                    </div>
                            ...
                            actionButton={
                                (hasPermission("user_master", "write") || user.role === "admin") && (
                                    <button
                                        ...
                                        className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#1e3a8a] text-white hover:bg-[#172554] transition-colors cursor-pointer shadow-sm hover:shadow"
                                        title="Create User"
                                    >
                    ...
                    <div className="flex-1 flex flex-col mb-8">
                        {/* <div className="mb-4 p-4 border border-slate-200 bg-white shadow-sm rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            <select
                                ...
                                className="block w-full sm:w-64 pl-3 pr-10 py-2 text-base border border-slate-300 focus:outline-none focus:ring-[#1e3a8a] focus:border-[#1e3a8a] sm:text-sm rounded-lg"
                            >

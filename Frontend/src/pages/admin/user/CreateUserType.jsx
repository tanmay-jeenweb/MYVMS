            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "1.5px solid #1e3a8a", color: isAllAll() ? "#fff" : "#1e3a8a",
                  background: isAllAll() ? "#1e3a8a" : "#e6ebf0", transition: "all 0.2s"
                }}
              >
                  ...
                  {PERMISSION_SECTIONS.map((section, secIdx) => (
                    <React.Fragment key={`sec-${secIdx}`}>
                      ...
                      <tr style={{ background: "linear-gradient(90deg, #f8fafc 0%, #eef2ff 100%)" }}>
                        <td colSpan={6} style={{ padding: "10px 14px", fontSize: 11, fontWeight: 800, color: "#1e3a8a", textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: "1px solid #e2e8f0" }}>
                          {section.title}
                        </td>
                      </tr>
                            ...
                            <td style={{ textAlign: "center", padding: "12px 8px", borderBottom: "1px solid #f1f5f9" }}>
                              <button
                                ...
                                style={{
                                  ...
                                  background: rowAll ? "#1e3a8a" : "#f8fafc",
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                background: saving ? "#94a3b8" : "linear-gradient(135deg,#1e3a8a,#172554)",
